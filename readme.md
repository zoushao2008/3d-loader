...
[![Version](https://img.shields.io/npm/v/3d-loader.svg)](https://www.npmjs.com/package/3d-loader) [![License](https://img.shields.io/npm/l/3d-loader.svg)](https://www.npmjs.com/package/3d-loader) [![Downloads](https://img.shields.io/npm/dt/3d-loader.svg)](https://www.npmjs.com/package/3d-loader)

[简体中文](./readme_CN.md)

Api document：<https://zoushao2008.github.io/3d-loader-docs/zh/>

Demo ：<https://zoushao2008.github.io/3d-loader/examples-demo/index.html>
...
```shell
npm i 3d-loader -S # npm install 3d-loader -save
```
...
## How to use 3d-loader

If use in global, insert code in entry file：

```js
/* vue2 */
import vue3dLoader from "3d-loader";
Vue.use(vue3dLoader);
...
```js
import { vue3dLoader } from "3d-loader"; // The vue3dLoader in {...}
```
...
<tr>
  ...
  Load the Gltf Draco model, you need to enable Draco decryption. After the Draco decryption library is enabled, you need to [download Draco decryption library](https://github.com/zoushao2008/3d-loader/blob/master/public/assets/draco.7z) and put it into the default directory assets. The default directory is assets/draco/gltf/. If you want to change the default draco directory, use <i>dracoDir</i> parameter. [About draco and threeJS](https://threejs.org/docs/index.html?q=draco#examples/en/loaders/DRACOLoader)
  </td>
</tr>
<tr>
  <td>
...
Need to download Draco repository storage with local static folder of your project, download url: <https://github.com/zoushao2008/3d-loader/blob/master/public/assets/draco.7z>
...
[Click here to see more demo code](https://github.com/zoushao2008/3d-loader/tree/master/src/examples)

### Docker deploy examples
```shell
  docker build -t vue/3d-loader .
  # docker run
  docker run -p 8010:80 vue/3d-loader
```
...
[issues](https://github.com/zoushao2008/3d-loader/issues)
...
This plugin is inseparable from [3d-model](https://github.com/hujiulong/3d-model)
