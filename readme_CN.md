...
Api 文档：<https://zoushao2008.github.io/3d-loader-docs/zh/>

演示：<https://zoushao2008.github.io/3d-loader/examples-demo/index.html>
...
```js
import { vue3dLoader } from "3d-loader"; // 注意 vue3dLoader 写在 {...} 内
```
...
<tr>
  ...
  加载Gltf draco模型需开启draco解密，开启后需要[下载draco解密库](https://github.com/zoushao2008/3d-loader/blob/master/public/assets/draco.7z)放到默认目录assets中，默认目录为assets/draco/gltf/，如需修改默认目录，请查看参数<i>dracoDir</i>。[关于draco请查阅](https://threejs.org/docs/index.html?q=draco#examples/en/loaders/DRACOLoader)
  </td>
</tr>
<tr>
  <td>
...
此功能需要先下载draco库存储与本地项目的静态文件夹内，才可以正常加载，下载地址：<https://github.com/zoushao2008/3d-loader/blob/master/public/assets/draco.7z>
...
[点我查看更多演示代码](https://github.com/zoushao2008/3d-loader/tree/master/src/examples)
...
![微信支付](/images/wxpay.jpg)

# ![支付宝支付](/images/alipay.png)

### 感谢

本插件参考[3d-model](https://github.com/hujiulong/3d-model)实现
